...
[![Version](https://img.shields.io/badge/version-0.19.1-blue.svg)](https://github.com/tbortolossi/panos-pbp-monitoring/releases/latest)
...
last read-only API check, monitoring run in progress), the 20 latest received
